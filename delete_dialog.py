...
class DeleteTaskDialog(QDialog):
    def __init__(self, task_id):
        ...
        self.delete_task_message_label = QLabel(
...
class DeleteProjectDialog(QDialog):
    def __init__(self, project_id):
        ...
        self.delete_project_message_label = QLabel(
    ...
    def delete_project_and_tasks(self):
        ...
        delete_project_tasks_confirmation.setInformativeText(
    ...
    def delete_project_only(self):
        ...
        delete_project_only_confirmation.setInformativeText(
            "Associated tasks are no longer assigned to any project"
        )
