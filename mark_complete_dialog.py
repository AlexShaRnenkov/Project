...
class MarkProjectCompleteDialog(MarkCompleteDialog):
    def __init__(self, project_id):
        ...
        self.project_completed_message = QLabel(
            "All tasks for this project are completed."
        )
...
class MarkProjectTasksCompleteDialog(MarkCompleteDialog):
    def __init__(self, project_id):
        ...
        self.project_tasks_message = QLabel(
            "Some tasks for this project are not yet completed."
        )
        self.mark_project_tasks_complete_message = QLabel(
            "Mark all project tasks complete?"
        )
        ...
        self.mark_project_tasks_complete_layout.addWidget(
            self.mark_project_tasks_complete_message
        )
        self.mark_project_tasks_complete_layout.addLayout(
            self.mark_complete_button_layout
        )
